...
function validarModal()
{
	...
	$.post("../buscadonantesadmin/php/funciones_objs.php",{"op":"newDonante","name":newName.val(),"apellido":newApe.val(),"sexo":newSexo.val(),"tel":newTel.val(),"doc":newDoc.val(),"correo":newMail.val()},respuesta_validarModal);
}
function closeModal()
{
	$(".modal").fadeOut();
